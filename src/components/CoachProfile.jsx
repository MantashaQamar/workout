...
const CoachProfile = () => {
  ...
  const [timeSlots, setTimeSlots] = useState([
    ...
    { time: '3:30 - 4:30 AM', available: true }
  ]);
  ...
  const handleBookWorkout = () => {
    if (selectedDate && selectedTimeSlot) {
      ...
      .then((response) => {
        ...
        toast.success('Your coach is booked!');
        setTimeout(() => {
          navigate('/dashboard')
        },3000);
      })
  ...
  return (
    ...
    {/* <Container maxWidth='lg'> */}
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={4} lg={3.5} style={{ position: {lg: 'fixed', xs: 'relative'}, top: 0, marginLeft: {lg: '2%', xs: '0'}, overflowY: 'auto' }} marginLeft={'2%'}>
